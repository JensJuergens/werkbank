...
---
In March more than 35% of Germany's  [power production](https://w3.windmesse.de/windenergie/news/31115-rekord-monat-erneuerbare-energie-strommix-deutschland-anteil-windenergie) were produced by renewable energy. But have you ever wondered, how you could get a reasonable production estimate for the next month?
This post is about the setup of a nice, small model, which is capable of forecasting daily production volumes of renewable power plants while being analytically tractable. All calculations are done with R and are implementations of methods carried out in the cited academic papers.
## Data Description
