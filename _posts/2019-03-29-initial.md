...
But, the truth is, that we have neglected the price. Including the power market into our analysis will make things more and more complicated. Consider this: You have carried out a perfect simulation and have weather information, which tell you to shift up production in Northern Germany wind parks. Unfortunately everyone else in the renewables business should know that, too, and hence will also boost production. Consequently prices will suffer as we have constant demand with oversupply which is called price cannibalisation. Hence we could end up with a relatively stable production, but with low prices, too. What I am trying to point out is, that it is not enough to diversify through asset classes, but also with the help of different pricing regions. This is were our Romanian solar park comes into play, which produces in a complete different pricing region. Leveraging on different pricing regions would be one way to fight against the price canibalisation effect, but there are many more.
