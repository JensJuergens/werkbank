...
This question can neither be easily answered, nor do I promise a crystal ball. But we can try to sketch future production with statistical means in order to get a sensible feeling for the uncertainty in renewables production profiles. In addition we will make our live easier by showing hot to invest in a portfolio with the right renewables asset mix to secure stable production figures.
